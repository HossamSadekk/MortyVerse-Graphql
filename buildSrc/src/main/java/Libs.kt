...
object DI {
    const val koin_android = "io.insert-koin:koin-android:3.5.2-RC1"
    const val koin_core = "io.insert-koin:koin-core:3.5.2-RC1"
    const val koin_navigation = "io.insert-koin:koin-androidx-navigation:3.5.2-RC1"
    const val koin_compose = "io.insert-koin:koin-androidx-compose:3.5.2-RC1"
    const val koin_junit4 = "io.insert-koin:koin-test-junit4:3.5.2-RC1"
}
object Pagination {
...
object ImageLoader {
    ...
    const val coil_skydov = "com.github.skydoves:landscapist-coil:1.5.2"
}
